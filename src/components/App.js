...
function App() {
  ...
  const renderDesign = () => {
    if (designIsOpen === true) {
      return(<section className="largeContainerDesign  js-design">
  ...
  const renderFill = () => {
    if (fillIsOpen === true) {
      return(<div action="" className="fill js-fill">
    ...
    const renderShare = () => {
      if (shareIsOpen === true) {
        return(<section className="buttonComparte js-share">
...
{/*  
          ...
          <fieldset className="share">
            <section className="buttonShare js-shareClick" onClick={handleToggleShare}>
